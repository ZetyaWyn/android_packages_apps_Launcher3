...
public final class AxAnimationEngine {
    ...
    /**
     * Linear-interpolated lookup into a precomputed table. ~10x cheaper than
     * PathInterpolator.getInterpolation() per call.
     */
    ...
    // Initialized statically at startup to guarantee zero IPC or system clock overhead per frame
