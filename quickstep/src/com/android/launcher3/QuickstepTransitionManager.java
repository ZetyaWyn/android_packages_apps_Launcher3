...
public class QuickstepTransitionManager implements OnDeviceProfileChangeListener {
    ...
    // Shortened from the stock 500ms. This is the single biggest lever for making the launch
    // animation *feel* faster: it's still long enough to read as a deliberate transition, but
    // trims ~100ms of "dead air" users perceive as lag when tapping an icon.
    ...
    // Kept proportional to the shortened APP_LAUNCH_DURATION above so open/close feel matched.
